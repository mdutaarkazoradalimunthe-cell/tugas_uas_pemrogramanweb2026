            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <form action="{{ route('events.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="nama_acara" value="{{ old('nama_acara') }}" class="w-full border-gray-300 rounded-lg" required>
                    </div>

                    <div class="grid grid-cols-2 gap-4 mb-4">
                        <div>
                            <label class="block font-medium mb-1">Tanggal Acara</label>
                            <input type="date" name="tanggal_utama" value="{{ old('tanggal_utama') }}" class="w-full border-gray-300 rounded-lg" required>
                        </div>
                        <div>
                            <label class="block font-medium mb-1">Jam Acara</label>
                            <input type="time" name="jam_utama" value="{{ old('jam_utama') }}" class="w-full border-gray-300 rounded-lg" required>
                        </div>
                    </div>

                    <div class="mb-4">
                        <label class="block font-medium mb-1">Lokasi Acara</label>
                        <input type="text" name="lokasi_utama" value="{{ old('lokasi_utama') }}" class="w-full border-gray-300 rounded-lg" required>
                    </div>
                    ...
                    <div id="pernikahan-fields" style="display: none;">
                        ...
                        <div class="grid grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <input type="text" name="nama_mempelai_pria" value="{{ old('nama_mempelai_pria') }}" class="w-full border-gray-300 rounded-lg">
                            </div>
                            <div>
                                <label class="block font-medium mb-1">Nama Mempelai Wanita</label>
                                <input type="text" name="nama_mempelai_wanita" value="{{ old('nama_mempelai_wanita') }}" class="w-full border-gray-300 rounded-lg">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <input type="text" name="nama_ortu_pria" value="{{ old('nama_ortu_pria') }}" class="w-full border-gray-300 rounded-lg">
                            </div>
                            <div>
                                <label class="block font-medium mb-1">Nama Orang Tua Wanita</label>
                                <input type="text" name="nama_ortu_wanita" value="{{ old('nama_ortu_wanita') }}" class="w-full border-gray-300 rounded-lg">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <input type="date" name="tanggal_resepsi" value="{{ old('tanggal_resepsi') }}" class="w-full border-gray-300 rounded-lg">
                            </div>
                            <div>
                                <label class="block font-medium mb-1">Jam Resepsi</label>
                                <input type="time" name="jam_resepsi" value="{{ old('jam_resepsi') }}" class="w-full border-gray-300 rounded-lg">
                            </div>
                        </div>

                        <div class="mb-4">
                            <label class="block font-medium mb-1">Lokasi Resepsi</label>
                            <input type="text" name="lokasi_resepsi" value="{{ old('lokasi_resepsi') }}" class="w-full border-gray-300 rounded-lg">
                        </div>
                    </div>
                    ...
                    <div class="flex gap-2 mt-6">
                        ...
                        <a href="{{ route('events.index') }}" class="px-4 py-2 bg-gray-200 rounded-lg hover:bg-gray-300">
                            Batal
                        </a>
                    </div>
                </form>
